...
var location_targets = {
	...
	'food_2_1': {x:1415, y:-193},
	'food_2_2': {x:1467, y:-194},
	'food_3_1': {x:1803, y:-193},
	'food_3_2': {x:1856, y:-195},
	'food_3_3': {x:1916, y:-193},
};
...
function eventScriptEventFired(event_id, target, args){
	if (event_id == 'items_added'){
		...
		if (!this.area_clear.area1 && 
			this.countItemClass(this.special_items.food_1_1.class_tsid) == 1 && 
...
function eventScriptStep(step, args){
	...
	switch (step){
		...
		case 'flamingo_1_talk3':
			...
			flamingo.talk(pc, 'Ah, EZ Cooking. Let\'s get started!', [{txt:'Aiight', value:'ok'}], 'tall');
			break;
